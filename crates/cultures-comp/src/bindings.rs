...
pub mod loremaster {
    ...
    pub mod cultures {
        ...
        pub mod types {
            ...
            #[repr(u8)]
            #[derive(Clone, Copy, Eq, PartialEq, strum::EnumIter)]
    ...
    pub mod loremaster {
        ...
        pub mod cultures {
            ...
            pub mod generate {
                ...
                pub unsafe fn _export_culture_cabi<T: Guest>() -> i32 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = T::culture();
                    result0.clone() as i32
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_name_cabi<T: Guest>(arg0: i32) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = T::name(super::super::super::super::loremaster::cultures::types::HeroicCulture::_lift(arg0 as u8));
                ...
                pub trait Guest {
                    ...
                    fn name(culture: HeroicCulture) -> _rt::String;
                }
                #[doc(hidden)]
      ...
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
        ...
        #[export_name = "loremaster:cultures/generate#culture"]
        unsafe extern "C" fn export_culture() -> i32 {
          $($path_to_types)*::_export_culture_cabi::<$ty>()
        }
        #[export_name = "loremaster:cultures/generate#name"]
        unsafe extern "C" fn export_name(arg0: i32,) -> *mut u8 {
          $($path_to_types)*::_export_name_cabi::<$ty>(arg0)
        }
        #[export_name = "cabi_post_loremaster:cultures/generate#name"]
...
macro_rules! __export_cultures_impl {
  ...
  $($path_to_types_root)*::exports::loremaster::cultures::generate::__export_loremaster_cultures_generate_cabi!($ty with_types_in $($path_to_types_root)*::exports::loremaster::cultures::generate);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:cultures:encoded world"]
#[doc(hidden)]
...
\x04\0\x07culture\x01\x02\x01@\x01\x07culture\x01\0s\x04\0\x04name\x01\x03\x04\x01\
\x1cloremaster:cultures/generate\x05\x02\x04\x01\x1cloremaster:cultures/cultures\
\x04\0\x0b\x0e\x01\0\x08cultures\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
