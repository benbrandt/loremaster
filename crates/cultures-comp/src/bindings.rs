...
// Options used:
pub type HeroicCulture = loremaster::cultures::types::HeroicCulture;
#[doc(hidden)]
...
pub unsafe fn _export_generate_name_cabi<T: Guest>(arg0: i32) -> *mut u8 {
    #[cfg(target_arch = "wasm32")]
    _rt::run_ctors_once();
    let result0 = T::generate_name(loremaster::cultures::types::HeroicCulture::_lift(
        arg0 as u8,
    ));
...
macro_rules! __export_world_cultures_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[export_name = "generate-culture"]
    unsafe extern "C" fn export_generate_culture() -> i32 {
      $($path_to_types)*::_export_generate_culture_cabi::<$ty>()
    }
    #[export_name = "generate-name"]
    unsafe extern "C" fn export_generate_name(arg0: i32,) -> *mut u8 {
      $($path_to_types)*::_export_generate_name_cabi::<$ty>(arg0)
    }
    #[export_name = "cabi_post_generate-name"]
    unsafe extern "C" fn _post_return_generate_name(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_generate_name::<$ty>(arg0)
    }
  };);
}
#[doc(hidden)]
pub(crate) use __export_world_cultures_cabi;
#[repr(align(4))]
...
pub mod loremaster {
    ...
    pub mod cultures {
        ...
        pub mod types {
            ...
            #[repr(u8)]
            #[derive(Clone, Copy, Eq, PartialEq, EnumIter)]
...
macro_rules! __export_cultures_impl {
  ...
  $($path_to_types_root)*::__export_world_cultures_cabi!($ty with_types_in $($path_to_types_root)*);
  )
}
#[doc(inline)]
...
A\x08\x01B\x02\x01m\x06\x08bardings\x16dwarves-of-durins-folk\x0felves-of-lindon\
...
-culture\x03\0\x0eheroic-culture\x03\0\x01\x01@\0\0\x02\x04\0\x10generate-cultur\
e\x01\x03\x01@\x01\x07culture\x02\0s\x04\0\x0dgenerate-name\x01\x04\x04\x01\x1cl\
oremaster:cultures/cultures\x04\0\x0b\x0e\x01\0\x08cultures\x03\0\0\0G\x09produc\
