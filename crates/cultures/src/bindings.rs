        ...
        pub mod cultures {
            ...
            pub mod generate {
                ...
                pub unsafe fn _export_generate_name_cabi<T: Guest>(arg0: i32) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = T::generate_name(super::super::super::super::loremaster::cultures::types::HeroicCulture::_lift(arg0 as u8));
